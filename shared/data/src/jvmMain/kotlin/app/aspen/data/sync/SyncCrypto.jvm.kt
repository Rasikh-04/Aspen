...
actual fun platformSyncCrypto(): SyncCrypto? = JavaxSyncCrypto

/** JDK-crypto implementation (identical to the androidMain actual — javax.crypto on both). */
internal object JavaxSyncCrypto : SyncCrypto {
